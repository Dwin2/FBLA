...
import {getDatabase, update, set, ref, get, child, onValue, remove} from "https://www.gstatic.com/firebasejs/9.16.0/firebase-database.js";
...
export {createUserWithEmailAndPassword, signInWithEmailAndPassword, update, signOut, set, ref, get, child, onValue, app, auth, database, userId, remove};